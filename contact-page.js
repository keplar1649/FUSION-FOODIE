            ...
            setTimeout(() => {
                ...
                switch(action) {
                    case 'location':
                        ...
                        // window.open('https://maps.google.com/?q=123+Fusion+Street+Delhi', '_blank');
                        break;
                    case 'call':
                        showToast('Opening phone dialer...', 'success');
                        // window.location.href = 'tel:+911182195650';
                        break;
                    case 'email':
                        showToast('Opening email client...', 'success');
                        // window.location.href = 'mailto:hello@fusionfoodie.com';
                        break;
                    case 'hours':
